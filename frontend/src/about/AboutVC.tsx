  ...
  return (
    ...
    >
      ...
      <p>
        ...
        engineering a software project for a local stakeholder. My group reached
        out to the University of Saskatchewan Students' Union (USSU) and their
        Vice President served as our stakeholder. We worked with him to design a
        platform to assist the USSU with finding student volunteers for their
        various events through campus.
      </p>
      <img
        src={vc_home}
      ...
      <p>
        ...
        involved with the database. I designed the Database Collections used to
        store all of the platform's information:
        <ul>
          <li>
            Students: personal and contact information, account email & password
            (hashed & salted), array of all IDs of submitted applications
          </li>
          <li>
            Organizations: corporate and contact information, account email &
            password (hashed & salted), array of all IDs of submitted volunteer
            postings
          </li>
          <li>
        ...
        I also designed a Database wrapper to help simply and lock down usage of
        the MongoDB database among my group members. I only allowed access to
        get, set, new, and delete operations (basic CRUD operations), in which I
        dynamically validated arguments and ran checks to ensure correct usage
        and prevent misuse.
      </p>
      <p>
        VolunteerConnect follows the Model-View-Controller (MVC) design pattern.
        The database acts as the Model and stores the state of the platform's
        interactions. The React frontend presents the View and coordinates with
        the Express backend for all actions. The Express backend serves as the
        Controller and connects the React frontend to the MongoDB backend.
      </p>
      <img
        src={vc_data}
        alt="MongoDB Setup"
      ...
      ></img>
      <p>
        Both organizations and students also have profiles that others can leave
        comments on.
      </p>
      <img
        src={vc_posts}
      ...
      ></img>
      <p>
        Overall, this project was my first introduction into team-based software
        development. Some of the most important things I learned during this
        process were:
        <ul>
          <li>
          ...
          <li>
            ...
            cannot be pushed out of the way. It counts as part of each feature,
            and a feature cannot be complete without it. If something is
            unclear, it needs to be documented so it IS clear to other team
            members.
          </li>
          <li>
            ...
            understand it. And, you don't want to start working the same feature
            that someone else started last week.
          </li>
        </ul>
      </p>
      <br />
